...
<footer class="section-p1">
  <div class="col ">
      ...
      <p><strong>Address:</strong>Kitebi Bunamwaya</p>
        <p><strong><i class="fa fa-phone"></i></strong><?php echo $contact_phone; ?></p>
		<p><strong><i class="fa fa-envelope-o"></i></strong> <?php echo $contact_email; ?></p>
        <p><strong>Hours:</strong>08:00am - 8:00pm, Man - Sun</p>
      <div class="follow">
          <h4>Follow Us</h4>
          <div class="icon col-md-6 col-sm-6 col-xs-12">
		  <ul>
						<?php
  ...
  <div class="col">
      ...
      <a href="faq.php">Delievery Information</a>
